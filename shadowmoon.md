...
@{Shadow/Sun Stealer|wtype}&{template:atkdmg} {{mod=[[@{dexterity_mod} +@{pb}]]}} {{rname=Suishen DEFENDING}} {{r1=[[@{Shadow/Sun Stealer|d20}cs>20 + 5[DEX] + 4[PROF] ?{Scabbard of Vigor}]]}} @{Shadow/Sun Stealer|rtype}cs>20 + 5[DEX] + 4[PROF] ?{Scabbard of Vigor}]]}} {{attack=1}} {{range=}} {{damage=1}} {{dmg1flag=1}} {{dmg1=[[1d8 + 5[DEX] ?{Scabbard of Vigor}]]}} {{dmg1type=Slashing}} {{damage=1}} {{dmg2flag=1}} {{dmg2=[[1d6]]}} {{dmg2type=Fire}} {{crit1=[[1d8[CRIT]]]}} {{crit2=[[1d10[CRIT]]]}} 0 {{spelllevel=}} {{innate=}} {{desc=Suishen is granting AC +4: [[@{AC}+4]]}} ammo @{Shadow/Sun Stealer|charname_output}
@{Shadow/Sun Stealer|wtype}&{template:atkdmg} {{mod=[[@{dexterity_mod} +@{pb}]]}} {{rname=Suishen DEFENDING}} {{r1=[[@{Shadow/Sun Stealer|d20}cs>20 + 5[DEX] + 4[PROF] ?{Scabbard of Vigor}]]}} @{Shadow/Sun Stealer|rtype}cs>20 + 5[DEX] + 4[PROF] ?{Scabbard of Vigor}]]}} {{attack=1}} {{range=}} {{damage=1}} {{dmg1flag=1}} {{dmg1=[[1d8 + 5[DEX] ?{Scabbard of Vigor}]]}} {{dmg1type=Slashing}} {{damage=1}} {{dmg2flag=1}} {{dmg2=[[1d6]]}} {{dmg2type=Fire}} {{crit1=[[1d8[CRIT]]]}} {{crit2=[[1d10[CRIT]]]}} 0 {{spelllevel=}} {{innate=}} {{desc=Suishen is granting AC +4: [[@{AC}+4]]}} ammo @{Shadow/Sun Stealer|charname_output}
```
...
```roll20
%{Shadow/Sun Stealer|repeating_attack_-Mc4SYEoW8lQ9giNeF7Y_attack}
```
...
%{Shadow/Sun Stealer|repeating_attack_-McdhGxQ60USI2vlaTz7_attack}
%{Shadow/Sun Stealer|repeating_attack_-McdhGxQ60USI2vlaTz7_attack}
```
...
```roll20
@{Shadow/Sun Stealer|perception_roll}
